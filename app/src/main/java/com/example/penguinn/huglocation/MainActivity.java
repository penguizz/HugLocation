...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(MainActivity.this,"การตรวจสอบไม่สำเร็จ",Toast.LENGTH_SHORT).show();
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    // Invalid request
                    Toast.makeText(MainActivity.this,"หมายเลขโทรศัพท์ไม่ถูกต้อง กรุณาตรวจสอบ",Toast.LENGTH_SHORT).show();
                    // ...
            ...
            public void onCodeSent(String verificationId,
                ...
                Toast.makeText(MainActivity.this,"กำลังส่งรหัสยืนยันไปยังหมายเลขโทรศัพท์ที่ระบุทาง SMS",Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this,"ส่ง OTP",Toast.LENGTH_SHORT).show();
                            // ...
                        } else {
                            // Log.w (TAG, "signInWithCredential:failure", task.getException());
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                // The verification code entered was invalid
                                Toast.makeText(MainActivity.this,"ไม่สามารถส่งรหัส OTP ได้",Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
    ...
    private void phoneNumberAuth() {
        ...
        builder.setMessage("ระบบกำลังจะส่งรหัสผ่านไปยังหมายเลขโทรศัพท์ กรุณากดยืนยัน");
